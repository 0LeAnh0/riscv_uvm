class risc_v_full_program_test extends risc_v_base_test;

    `uvm_component_utils(risc_v_full_program_test)
    ...
    function new(string name, uvm_component parent);
        ...
        my_name = "risc_v_full_program_test";
    endfunction

    function void build_phase(uvm_phase phase);
        super.build_phase(phase);
        uvm_report_info(my_name, "full program test build phase");
    ...
    task run_phase(uvm_phase phase);
        ...
        phase.raise_objection(this, "Objection raised by risc_v_full_program_test");
        
        // Start the sequence
        risc_v_master_full_prog_seq.start(env_h.risc_v_master_agent_0.sequencer, null);

        phase.drop_objection(this, "Objection dropped by risc_v_full_program_test");
    endtask
