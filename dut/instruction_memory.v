...
initial begin
    ...
    if ($value$plusargs("INSTR_FILE=%s", instr_file)) begin
        ...
        codeMemory[42] = 32'h029c8e23; 
        codeMemory[43] = 32'h040f2f03; 
        codeMemory[44] = 32'h003f9437; 
        codeMemory[45] = 32'h04949223; 
        codeMemory[46] = 32'h0032fa37; 
        codeMemory[47] = 32'h048cc303; 
        codeMemory[48] = 32'h00446a17; 
        codeMemory[49] = 32'h00100c97; 
        codeMemory[50] = 32'h0074e437; 
        codeMemory[51] = 32'h0509a903; 
        codeMemory[52] = 32'h04192a23; 
        codeMemory[53] = 32'h00f8e863; 
        codeMemory[54] = 32'h00e25a63; 
        codeMemory[55] = 32'h058aaa83; 
        codeMemory[56] = 32'h05c12583; 
        codeMemory[57] = 32'h40115e33; 
        codeMemory[58] = 32'h06052603; 
        codeMemory[59] = 32'h064aa983; 
    end
end
